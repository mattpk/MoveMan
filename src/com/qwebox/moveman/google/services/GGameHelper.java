package com.qwebox.moveman.google.services;
...
public class GGameHelper implements GoogleApiClient.ConnectionCallbacks,
	 ...
	 */
	public GGameHelper(Activity activity, int clientsToUse) {
		mActivity = activity;
	...
	public void onActivityResult(int requestCode, int responseCode,
		...
		debugLog("onActivityResult: req="
				...
				+ GGameHelperUtils.activityResponseCodeToString(responseCode));
	...
	public void onConnectionFailed(ConnectionResult result) {
		...
		debugLog("   - code: "
				+ GGameHelperUtils.errorCodeToString(mConnectionResult
						.getErrorCode()));
	...
	void giveUp(SignInFailureReason reason) {
		...
		if (reason.mActivityResultCode == GamesActivityResultCodes.RESULT_APP_MISCONFIGURED) {
			...
			GGameHelperUtils.printMisconfiguredDebugInfo(mAppContext);
		}
	...
	public static void showFailureDialog(Activity activity, int actResp,
		...
		case GamesActivityResultCodes.RESULT_APP_MISCONFIGURED:
			errorDialog = makeSimpleDialog(activity,
					GGameHelperUtils.getString(activity,
							GGameHelperUtils.R_APP_MISCONFIGURED));
			break;
		case GamesActivityResultCodes.RESULT_SIGN_IN_FAILED:
			errorDialog = makeSimpleDialog(activity,
					GGameHelperUtils.getString(activity,
							GGameHelperUtils.R_SIGN_IN_FAILED));
			break;
		case GamesActivityResultCodes.RESULT_LICENSE_FAILED:
			errorDialog = makeSimpleDialog(activity,
					GGameHelperUtils.getString(activity,
							GGameHelperUtils.R_LICENSE_FAILED));
			break;
		default:
			...
			if (errorDialog == null) {
				...
				errorDialog = makeSimpleDialog(
						activity,
						GGameHelperUtils.getString(activity,
								GGameHelperUtils.R_UNKNOWN_ERROR)
								+ " "
								+ GGameHelperUtils.errorCodeToString(errorCode));
			}
		}
	...
	public static class SignInFailureReason {
		...
		public String toString() {
			return "SignInFailureReason(serviceErrorCode:"
					+ GGameHelperUtils.errorCodeToString(mServiceErrorCode)
